...
namespace TrainWorld
{
    ...
    public class Rail : MonoBehaviour
    {
        ...
        public void Visualize(Vector3Int placementStartPosition, Vector3Int placementEndPosition, Direction placementStartDirection, Direction placementEndDirection)
        {
            curve = new Curve(placementStartPosition, placementEndPosition, placementStartDirection, placementEndDirection);
            Vector3[] points = curve.CalculateEvenlySpacedPoints(spacing);
            GetComponent<MeshFilter>().mesh = CreateRailMesh(points, placementStartDirection, placementEndDirection);
